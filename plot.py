...
def heatmap(x,y,size, color, fig_size = (10,10)):
    ...
    # This code is inspired by the following article: https://towardsdatascience.com/better-heatmaps-and-correlation-matrix-plots-in-python-41445d0f2bec
    sns.set()
...
def main():
    ...
    print('reduced_df shape', reduced_df.columns)
